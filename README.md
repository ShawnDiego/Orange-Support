# Orange Player · 你的 Windows 个人影视库

![Orange Player - 你的 Windows 个人影视库](assets/hero.png)

> Windows 上的个人影视库管理与沉浸播放工具：把本地文件夹、NAS、网盘和媒体服务器里的内容，整理成一个好找、好看、好播的影视库。

**本仓库只承载产品公开说明、版本信息、公开问题讨论和安全报告入口，不包含 Orange Player 主程序源码，也不是开源代码仓库。成品首选 Microsoft Store，同时在 Releases 提供 GitHub 直装包。**
...
- 如果 Orange Player 帮到了你，请在商店里打个评分、留句话——这是对我们最大的支持 🙏
...
- [Orange Player 官网](https://orange-official-site-orange1-d2gaxdul7d814785d.webapps.tcloudbase.com/)
- [产品介绍](PRODUCT.md)（本仓库）
...
2. 仍有问题，用 [Issue 模板](https://github.com/ShawnDiego/Orange-Support/issues/new/choose) 提交：Orange Player 版本、Windows 版本、发生页面、最短复现步骤、实际 vs 预期结果。
